<template>
	<view class="p-2 animated fadeInLeft fast">
		<view class="flex mb-2">
			...
			class="icon iconfont icon-zengjia bg-grey text-white rounded w-10 h-6 px-1">关注</view>
			<view v-else class="icon iconfont border border-grey text-grey rounded w-10 h-6 px-1">已关注</view>
		</view>
		...
		<view class="relative">
			...
			<!-- 文章标题 -->
			<view class="text-xl mb-2 absolute" style="bottom: 40rpx;left: 20rpx;">{{item.title}}</view>
			<!-- 遮罩层 -->
			<view class="mask rounded">
			</view>
		</view>
